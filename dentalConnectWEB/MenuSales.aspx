<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuSales.aspx.cs" Inherits="dentalConnectWEB.MenuSales" %>
             ...
             <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="administrarDropdown">
                        <a class="dropdown-item" href="empresas.html"><img src="images/functions/edificio.png" alt="" width="15px" height="15px"> Empresas</a>
...
<div class="row justify-content-center">
        ...
        <div class="col-md-8 mt-4">
            <div class="widget saludo-widget">
                ...
                <p style="font-size: 20px;"><b>ROL: GERENTE DE VENTAS</b></p>
